...
if ("Java" in text):
    ...
    print("Text contine alte cuvinte, in afara de Java")
# CODUL TĂU VINE MAI SUS:
...
if("Python" in text):
    ...
    print("Textul nu contine nici Python nici Java")
# CODUL TĂU VINE MAI SUS:
...
if ("Python" in text and "Java" in text):
    print("Textul contine cuvintul Python si Java")
elif("Python" in text or "Java" in text):
    print("Textul contine sau Python sau Java")
else:
    print("Textul nu contine nici Python nici Java")
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
number = input("Introduceti un numar de la 1 la 5: ")
if number == str(1):
    print("Unu")
elif number == str(2):
    print("Doi")
