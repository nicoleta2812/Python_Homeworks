...
# CODUL TĂU VINE MAI JOS:
def task_5(n):
    return ["par" if i % 2 == 0 else "impar" for i in range(1,11)]
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
def task_10(nume, virsta, oras):
    print(f"Nume: {nume}, Virsta: {virsta}, Oras:{oras}") 
task_10("Ana", 32, oras = "Bucuresti")
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
def task_15(cuvintul):
    return cuvintul == cuvintul[::-1]
# CODUL TĂU VINE MAI SUS:
