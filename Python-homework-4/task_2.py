...
# CODUL TĂU VINE MAI JOS:
text = "Am executat sarcinile pentru hw3.\nAcum execut sarcinile pentru hw4 din cursul Python"
print(text)
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
f_string = f'Hello!, Am creat o variabila cu numele meu {name} si a doua la fel {name2}'
print(f_string)
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
format_string = "Am create 2 variabile: una cu numele meu -{} si a doua la fel -{}".format(name, name2)
print(format_string)
# CODUL TĂU VINE MAI SUS:
